...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
                    ...
                    for (int i = 1; i <= 13; i++)
                    {
                        for (int j = 1; j <= 4; j++)
                        {
                            ...
                            if (j == 4)
                            {
                                ...
                                koltuk2.Location = new Point(70 * i, 70 * j);
                                koltuk2.ContextMenuStrip = contextMenuStrip1;
                                koltuk2.MouseDown += Koltuk2_MouseDown;
                                this.Controls.Add(koltuk2);
        ...
        private void Koltuk2_MouseDown(object sender, EventArgs e)
        { Button secilenkoltuk = (Button)sender; }
            private void kADINToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (comboBox1.SelectedIndex == comboBox2.SelectedIndex)
            {
                MessageBox.Show("Lütfen Kalkış ve Varış Noktalarını Farklı Seçiniz.");
                return;
            }
            ...
            { 
                MessageBox.Show("Lütfen Kalkış Noktasını Seçiniz.");
                return;
            }
            if (comboBox2.SelectedIndex  == -1)
            {
                MessageBox.Show("Lütfen Varış Noktasını Seçiniz.");
                return;
            }
            if (comboBox3.SelectedIndex == -1)
            {
                MessageBox.Show("Lütfen Sefer Saatini Seçiniz.");
                return;
            }
          ...
          f.Form2ye_Gidecek_Veri4 = mesaj4;
            f.Form2ye_Gidecek_Veri5 = mesaj5;
